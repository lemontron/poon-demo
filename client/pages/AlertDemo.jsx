...
import { List, Reveal, showAlert, toast, TouchableRow, ScrollView } from 'meteor/poon';
...
const alerts = [{
	...
	'onClick': () => showAlert({
		title: 'Demo Alert',
		message: 'Even though this alert has no options, a close button is added by Poon.',
	}).then(handleResult),
}, {
